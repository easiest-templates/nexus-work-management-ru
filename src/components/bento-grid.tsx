    ...
    <section id="features" className="py-24 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            Все для быстрого релиза
          </h2>
          <p className="text-zinc-400 max-w-2xl mx-auto">
            Создано для современных команд. Мощные инструменты для разработки, деплоя и масштабирования.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Мониторинг в реальном времени</h3>
                <p className="text-zinc-400 text-sm">
                  Отслеживайте состояние системы, метрики и алерты в реальном времени на всех деплоях.
                </p>
              </div>
              <SystemStatus />
            </div>
            <div className="grid grid-cols-4 gap-4">
              {["CPU", "Память", "Сеть", "Диск"].map((metric) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Командная строка</h3>
            <p className="text-zinc-400 text-sm mb-6">Мгновенная навигация с помощью горячих клавиш.</p>
            <KeyboardCommand />
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">Глубокий анализ производительности приложения.</p>
            <AnimatedChart />
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Молниеносная скорость</h3>
            <p className="text-zinc-400 text-sm mb-4">
              Edge-инфраструктура с откликом менее 50мс по всему миру.
            </p>
            <div className="flex items-center gap-2 text-emerald-500 text-sm">
              <span className="font-mono">~32мс</span>
              <span className="text-zinc-500">средний отклик</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Корпоративная защита</h3>
            <p className="text-zinc-400 text-sm mb-4">SOC2-сертификация, сквозное шифрование и поддержка SSO.</p>
            <div className="flex items-center gap-2">
