    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-zinc-400">Открытая бета-версия</span>
        </motion.div>
        ...
        >
          Современная платформа для команд, которые ценят скорость. Создана для масштабирования, спроектирована
          для производительности. Все, что нужно для разработки и роста.
        </motion.p>
        ...
        >
          ...
          <p className="text-sm text-zinc-500">
            Нам доверяют <span className="text-zinc-300 font-medium">2 000+</span> команд по всему миру
          </p>
        </motion.div>
      </div>
    </section>
