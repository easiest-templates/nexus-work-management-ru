...
const plans = [
  {
    name: "Старт",
    description: "Для пет-проектов и небольших команд",
    price: { monthly: 0, yearly: 0 },
    features: ["3 участника", "10 проектов", "Базовая аналитика", "Поддержка сообщества", "1 ГБ хранилище"],
    cta: "Начать",
    highlighted: false,
  },
  {
    name: "Про",
    description: "Для растущих команд с амбициями",
    price: { monthly: 2900, yearly: 2400 },
    features: [
      "Безлимит участников",
      "Безлимит проектов",
        ...
        >
          ...
          <div className="inline-flex items-center p-1 rounded-full bg-zinc-900 border border-zinc-800">
            ...
            >
              ...
              <span className="relative z-10">Год</span>
            ...
            >
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold text-white">{plan.price[billingCycle].toLocaleString('ru-RU')} ₽</span>
                  {plan.price.monthly > 0 && <span className="text-zinc-400 text-sm">/мес</span>}
                </div>
                {billingCycle === "yearly" && plan.price.yearly > 0 && (
                  <p className="text-xs text-zinc-500 mt-1">При оплате за год ({(plan.price.yearly * 12).toLocaleString('ru-RU')} ₽/год)</p>
                )}
              </div>
