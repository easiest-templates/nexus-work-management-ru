    ...
    >
      ...
      >
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-white hidden sm:block">Velocite</span>
        </a>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <Button className="shimmer-btn bg-white text-zinc-950 hover:bg-zinc-200 rounded-full">Начать</Button>
          </div>
        </motion.div>
      )}
    </motion.header>
